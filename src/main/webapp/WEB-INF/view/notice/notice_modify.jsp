				...
				<div class="col-auto ml-auto text-right mt-n1 pl-3 d-none d-sm-inline-block">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
							...
							<li class="breadcrumb-item text-danger">수정</li>
						</ol>
					</nav>
				</div>
	          ...
	          <!-- 공지사항 수정 -->
						<div class="card bg-white" >
							<div class="card-header bg-white">
								<h5 class="card-title text-center"><strong>공지사항 수정</strong></h5>
							</div>						
			         <form action="../notice/modify" method="post" enctype="multipart/form-data"> 
				          <div class="row">
				            <div class="col col-1" ></div> 
				            <span class="col-2 input-group-text-demi" ><b>제    목</b></span>
				            <input type="text" value="${n.title }" name="title" class="col-6 form-control" style="width:70%;background: rgb(91%, 94%, 100%);" required>
				            <div class="col col-1"></div> 
				          </div> 
				          <div class="row">
				            <div class="col col-1" ></div> 
				            <span class="col-2 input-group-text-demi"><b>작성자</b></span>
				            <input type="text" name="writer_id" value="${n.writer_id }" class="col-6 form-control" style="width:70%;background: white;" readonly>
				            <div class="col col-1"></div> 
				          </div>             
			<!--        기존에 첨부파일이 있었으면 -->
				          <c:forTokens items="${n.files }" delims="," var="fileName">
				          	<c:set var="nCnt" value="${nCnt + 1 }" />
					          <div class="row">
					            <div class="col col-1" ></div> 
						            <span class="col-2 input-group-text-demi" ><b>첨부파일${nCnt }</b></span>
										  <input class="form-control" value="" name="newFile" type="file" id="noticeFile1" style="width:40%;rgb(91%, 94%, 100%);">
					            	<input type="text" name="oldFile" value="${fileName }" class="col-6 form-control" style="width:20%;background:rgb(91%, 94%, 100%);" readonly>
				              <div class="form-control" style="width:10%; background:rgb(91%, 94%, 100%);">
					              <input class="form-check-input" name="chkAttDel" type="checkbox" value="${fileName }" id="flexCheckDefault">
				          ...
				          <!--  기존에 첨부파일이 하나만 있었으면 하나 추가 표시 -->   
			            <c:if test="${nCnt == '1'}">
					          <div class="row">
					            <div class="col col-1" ></div> 
						            <span class="col-2 input-group-text-demi" ><b>첨부파일2</b></span>
										  <input class="form-control" value="" name="newFile" type="file" id="noticeFile1" style="width:40%;rgb(91%, 94%, 100%);">
					            <input type="text" name="oldFile" value="" class="col-6 form-control" style="width:20%;background:rgb(91%, 94%, 100%);" readonly>
				              <div class="form-control" style="width:10%; background:rgb(91%, 94%, 100%);">
					              <input class="form-check-input" name="chkAttDel" type="checkbox" value="" id="flexCheckDefault">
											  <label class="form-check-label" for="flexCheckDefault">
											    삭제
											  </label>
										  </div>			            
			...
			<!--        기존에 첨부파일이 없었으면 -->
			            <c:if test="${n.files == null}">
					          <c:forEach var="i" begin="0" end="1" varStatus="st">
						          <div class="row">
						            <div class="col col-1" ></div> 
							            <span class="col-2 input-group-text-demi" ><b>첨부파일${i+1 }</b></span>
											  <input class="form-control" value="" name="newFile" type="file" id="noticeFile1" style="width:40%;rgb(91%, 94%, 100%);">
						            <input type="text" name="oldFile" value="" class="col-6 form-control" style="width:20%;background:rgb(91%, 94%, 100%);" readonly>
					              <div class="form-control" style="width:10%; background:rgb(91%, 94%, 100%);">
						              <input class="form-check-input" name="chkAttDel" type="checkbox" value="" id="flexCheckDefault">
				          ...
				          <div class="row">
				            ...
				            <textarea class="col-6 form-control" name="content" style="width:70%;background: rgb(91%, 94%, 100%);height:150px" aria-label="With textarea" required>${n.content }</textarea>
				            <div class="col col-1"></div> 
				          </div>
				<!-- 목록으로 가기버튼 -->
				         ...
				         <input type="hidden" name="id" value="${n.id }"> 
							   ...
							   <input type="hidden" name="oldFiles" value="${n.files }"	>          
			          </form>   
						</div>
					</div>					
				</div>
