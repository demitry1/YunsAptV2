...
<!-- ---------------------------------------------------------------------------------------- -->			
          ...
          <div class="col-md-6 d-flex">
            <div class="my-3 my-lg-0 bg-white border rounded border-light p-4 p-lg-5 w-100">
	             ...
	             <form id="loginform" action="../login/join" method="post">
	                <div class="form-group mb-4">
	                    <label for="user">아이디</label>
	                    <div class="input-group">
	                        <span class="input-group-text" id="basic-addon1"><span class="fas fa-user"></span></span>
	                        <input type="text" class="form-control" placeholder="userid" id="userid" name="userid" autofocus style="line-height: 2" required>
	                    </div>  
	                </div>
	                ...
	                <div class="form-group">
	                    <div class="form-group mb-4">
	                        ...
	                        <div class="input-group">
	                            <span class="input-group-text" id="basic-addon2"><span class="fas fa-unlock-alt"></span></span>
	                            <input type="password" placeholder="Password confirm" name="password2" class="form-control" id="password" style="line-height: 2">
	                        </div>  
	                    </div>
	                </div>
	                <div class="form-group mb-4">
	                    ...
	                    <div class="input-group">
	                        ...
	                        <input type="text" class="form-control" placeholder="username" id="username" name="username" autofocus style="line-height: 2" required>
	                    </div>  
	                </div>         
	                <div class="form-group mb-4">
	                    ...
	                    <div class="input-group">
	                        ...
	                        <input type="text" class="form-control" placeholder="email" id="email" name="email" autofocus style="line-height: 2" required>
	                        <span class="input-group-text">@</span> 
	                        <input type="text" class="form-control" placeholder="gmail.com" id="email2" name="email2" autofocus style="line-height: 2" required>
	                    </div>  
	                </div>         
	                <button type="submit" class="btn btn-block btn-primary" id="joinsave" name="cmd" value="joinsave">가입하기</button>
	                <button type="submit" class="btn btn-block btn-danger" name="cmd" value="joincancel">취소하기</button>
	             </form>
            </div>
          </div>
          </div>
