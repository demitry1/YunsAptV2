				...
				<div class="col-auto ml-auto text-right mt-n1 pl-3 d-none d-sm-inline-block">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
							...
							<li class="breadcrumb-item"><a href="../index">서울지역</a></li>
...
<!--      조건검색 / 버튼 영역 -->			
					<div class="row pb-2">
            <form action="../aptinfo/aptinfo" method="get" name="f" id="f">
           		 <div class="row">
	              	...
	              	<div class="col-md-2 pb-1">
		                <select class="form-select" id="construction_year_info" name="construction_year">
          		 ...
          		 <div class="row mt-2 mb-3">
          		    ...
          		    <!--  아파트명 검색 -->
		                  ...
		                  <div class="col-md-6 pb-1">
			                  <button type="submit" class="btn btn-primary w-100"  id="infoserach" value="normal" name="search">검 색</button>
			                </div>			            			
								    </div>
          		    <!--   끝 -->           		    
                  </div>
...
<!-- ------------------------------------------------------------ -->	
					<div class="row">
	          <form action="../aptinfo/aptinfo_detail" method="post" name="aptform" id="aptform"> 
	                ...
	                <ul class="pagination justify-content-center">      
	                  <li class="page-item">
											<a class="page-link" aria-label="first" 
											   href="?p=1&city_do=${param.city_do}&city_gu=${param.city_gu}&dong_gu=${param.dong_gu}&construction_year=${param.construction_year}&apt_name=${param.apt_name}&search=${param.search}&infoall=${param.infoall}&listcnt=${param.listcnt}">
	                  ...
	                  <li class="page-item">
											<c:if test="${startNum > 1 }">	
												<a class="page-link" aria-label="Previous" 
												   href="?p=${startNum-1}&city_do=${param.city_do}&city_gu=${param.city_gu}&dong_gu=${param.dong_gu}&construction_year=${param.construction_year}&apt_name=${param.apt_name}&search=${param.search}&infoall=${param.infoall}&listcnt=${param.listcnt}">
										...
										<c:forEach var="i" begin="0" end="4">
											<c:if test="${(startNum+i) <= lastNum }">
												<li class="page-item ${page==(startNum+i)?'active':'' }">
													<a class="page-link" href="?p=${startNum+i}&city_do=${param.city_do}&city_gu=${param.city_gu}&dong_gu=${param.dong_gu}&construction_year=${param.construction_year}&apt_name=${param.apt_name}&search=${param.search}&infoall=${param.infoall}&listcnt=${param.listcnt}">${startNum+i}
													 </a>
												 </li>
											</c:if>
										</c:forEach>		                  
	                  <li class="page-item">
											<c:if test="${lastNum > startNum+4 }">
												<a class="page-link" aria-label="Next" 
												   href="?p=${startNum+5}&city_do=${param.city_do}&city_gu=${param.city_gu}&dong_gu=${param.dong_gu}&construction_year=${param.construction_year}&apt_name=${param.apt_name}&search=${param.search}&infoall=${param.infoall}&listcnt=${param.listcnt}">
	                  ...
	                  <li class="page-item">
											<a class="page-link" aria-label="Last" 
											   href="?p=${lastNum }&city_do=${param.city_do}&city_gu=${param.city_gu}&dong_gu=${param.dong_gu}&construction_year=${param.construction_year}&apt_name=${param.apt_name}&search=${param.search}&infoall=${param.infoall}&listcnt=${param.listcnt}">
...
<!--  아파트 실거래가 검색을 위한 히든필드 -->				   
							<input type="hidden" name="city_do2" id="city_do2">   
							<input type="hidden" name="city_gu2" id="city_gu2">   
							<input type="hidden" name="dong_gu2" id="dong_gu2">   
							<input type="hidden" name="apt_name2" id="apt_name2">   
							<input type="hidden" name="construction_year2" id="construction_year2">   
							<input type="hidden" name="address_road2" id="address_road2">   
							<input type="hidden" name="address_jibun2" id="address_jibun2">   
	          </form>   			
