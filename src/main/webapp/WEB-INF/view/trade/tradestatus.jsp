				...
				<div class="col-auto ml-auto text-right mt-n1 pl-3 d-none d-sm-inline-block">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
							...
							<li class="breadcrumb-item text-danger">일자별</li>
						</ol>
					</nav>
				</div>
...
<!--      조건검색 / 버튼 영역 -->			
					<div class="row pb-2">
            <form action="../trade/tradestatus" method="get" name="f" id="f">
           		 <div class="row">
          		 ...
          		 <div class="row mt-2 mb-3">
	            		<div class="col-md-2 pb-1 ">
										<input type="text" name="contract_date1" class="datapicker form-select" id="datepicker3" size="15" value="${param.contract_date1 }">
									</div>	
	            		<div class="col-md-2 pb-1">
										<input type="text" name="contract_date2" class="datapicker form-select" id="datepicker4" size="10" value="${param.contract_date2 }">
	            		</div>          		
	              	<div class="col-md-2 pb-1">
